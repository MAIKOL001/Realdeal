                    ...
                    <div class="col-lg-12">
                        <div class="invoice-inner-9" id="invoice_wrapper">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 mb-50">
                                        <div class="invoice-number">
                                            <h4 class="inv-title-1">Waybill date:</h4>
                                            <p class="invo-addr-1">
                            ...
                            <div class="invoice-informeshon-footer">
                                <ul>
                                    <li><a href="#">www.Realdeallogistics.com</a></li>
                                    <li><a href="mailto:sales@hotelempire.com">Realdeal@gmail.com</a></li>
                                    <li><a href="tel:+088-01737-133959">+254 758 928 555</a></li>
                                </ul> 
                  </div>
                        </div>
