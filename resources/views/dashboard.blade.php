            ...
            <div class="row row-deck row-cards">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="h1 mb-3">{{$sheetorder}}</div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-baseline">
                                <div class="h1 mb-0 me-2">{{$deliveredCount}}</div>
                                <div class="me-auto">
                                <span class="text-green d-inline-flex align-items-center lh-1">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="subheader">Dispatched</div>
                                <div class="ms-auto lh-1">
                                    <div class="dropdown">
                                        <a class="dropdown-toggle text-muted" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Last 7 days</a>
                                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="d-flex align-items-baseline">
                                <div class="h1 mb-3 me-2">{{$dispatchedCount}}</div>
                                <div class="me-auto">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-baseline">
                                <div class="h1 mb-3 me-2">{{$cancelledCount}}</div>
                                <div class="me-auto">
                                <span class="text-green d-inline-flex align-items-center lh-1">
                ...
                <div class="col-lg-12">
                    <div class="row row-cards">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <p class="mb-3">Order Tracker Scale<br><strong> Total Orders: {{$sheetorder}} </strong></p>
                                    <div class="progress progress-separated mb-3">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: {{$deliveredCount}}%" aria-label="Regular"></div>
                                        <div class="progress-bar bg-danger" role="progressbar" style="width: {{$cancelledCount}}%" aria-label="System"></div>
                                        <div class="progress-bar bg-warning" role="progressbar" style="width: 9%" aria-label="Shared"></div>
                                    </div>
                                    <div class="row">
                                        <div class="col-auto d-flex align-items-center pe-2">
                                            <span class="legend me-2 bg-success"></span>
                                            <span>Delivered</span>
                                            <span class="d-none d-md-inline d-lg-none d-xxl-inline ms-2 text-muted">{{$deliveredCount}}</span>
                                        </div>
                                        <div class="col-auto d-flex align-items-center px-2">
                                            <span class="legend me-2 bg-danger"></span>
                                            <span>Cancelled</span>
                                            <span class="d-none d-md-inline d-lg-none d-xxl-inline ms-2 text-muted">{{$cancelledCount}}</span>
                                        </div>
                                        <div class="col-auto d-flex align-items-center px-2">
                                            <span class="legend me-2 bg-warning"></span>
                                            <span>Returned</span>
                                            <span class="d-none d-md-inline d-lg-none d-xxl-inline ms-2 text-muted">45</span>
                                        </div>
